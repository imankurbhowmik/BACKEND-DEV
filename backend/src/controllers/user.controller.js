...
const getCurrentUser = asyncHandler(async(req, res) => {
    return res.send(200).json(200, req.user, "current user fetched succesfully")
})
...
const updateAccountDetails = asyncHandler(async(req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, user, "user account details fetched successfully"))
})
...
const getUserChannelProfile = asyncHandler(async(req, res) => {
    ...
    if(!channel?.length){
        throw new ApiError(401, "channel doesnt exist")
    }
...
export { registerUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, updateAccountDetails, updateUserAvatar, updateUserCoverImage, getUserChannelProfile, getUserHistory };